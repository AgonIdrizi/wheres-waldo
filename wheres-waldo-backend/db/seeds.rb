...
characters_data = [
  ...
  { puzzle: "hard",
    characters: [ { name: "waldo", top_left_x: 1012, top_left_y: 248,
                    width: 15, height: 23 },
                  { name: "wenda", top_left_x: 529, top_left_y: 482,
                    width: 10, height: 16 },
                  { name: "wizard", top_left_x: 585, top_left_y: 266,
                    width: 12, height: 23 },
                  { name: "odlaw", top_left_x: 415, top_left_y: 492,
                    width: 12, height: 22 } ] 
  },
  { puzzle: "very hard",
    characters: [ { name: "waldo", top_left_x: 659, top_left_y: 137,
                    width: 17, height: 31 },
                  { name: "wenda", top_left_x: 527, top_left_y: 524,
                    width: 12, height: 31 },
                  { name: "wizard", top_left_x: 960, top_left_y: 45,
                    width: 15, height: 19 },
                  { name: "odlaw", top_left_x: 414, top_left_y: 519,
                    width: 11, height: 31 } ] 
  },
  { puzzle: "insane",
